...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="w-full bg-[#FFFFFF] border-t border-gray-200 pt-12 pb-8 px-4 sm:px-6 lg:px-8 text-gray-600 font-sans">
        <div className="max-w-[1400px] mx-auto">

          {/* MAIN 4-COLUMN LAYOUT */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-14 text-left">

            {/* COLUMN 1: NEXCINEMA BRAND & DESCRIPTION & SOCIAL */}
            <div className="space-y-4">
              <Link to="/" className="flex items-center gap-3 shrink-0 inline-flex group">
                <img 
                  src={UITLogo} 
                  alt="NexCinema Logo" 
              ...
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed max-w-xs font-normal">
              ...
              <div className="flex items-center gap-4 pt-2">
                <a 
                  href="https://nexcinema.vn" 
                  target="_blank" 
                  rel="noreferrer"
                  className="text-gray-600 hover:text-[#8B1D1D] transition-colors"
                  title="Website"
                >
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-3 text-xs sm:text-sm text-gray-600">
                ...
                <li className="flex items-start gap-2.5">
                  <Clock className="w-4 h-4 text-[#8B1D1D] shrink-0 mt-0.5" />
                  <span className="leading-relaxed">
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2.5 text-xs sm:text-sm text-gray-600">
                <li className="flex items-center gap-2.5">
                  <Phone className="w-4 h-4 text-[#8B1D1D] shrink-0" />
                  <span>Hotline: <strong className="text-gray-900 font-bold">1900 8888</strong></span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Mail className="w-4 h-4 text-[#8B1D1D] shrink-0" />
                  <a href="mailto:support@nexcinema.vn" className="hover:text-[#8B1D1D] transition-colors">
                    support@nexcinema.vn
                  </a>
                </li>
                <li className="flex items-center gap-2.5">
                  <ShieldCheck className="w-4 h-4 text-[#8B1D1D] shrink-0" />
                  <button 
                    onClick={() => setModalType('SUPPORT_POLICY')}
                    className="hover:text-[#8B1D1D] transition-colors text-left cursor-pointer"
                  >
